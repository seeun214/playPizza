...
insert into menu values(MENU_SEQ.nextval, '페퍼로니 피자', 20000);
insert into menu values(MENU_SEQ.nextval, '치즈 피자', 18000);
insert into menu values(MENU_SEQ.nextval, '야채 피자', 20000);
insert into menu values(MENU_SEQ.nextval, '베리 피자', 20000);
insert into menu values(MENU_SEQ.nextval, '시카고 피자', 20000);
insert into menu values(MENU_SEQ.nextval, '토마토 파스타', 6000);
insert into menu values(MENU_SEQ.nextval, '콜라', 3000);
insert into menu values(MENU_SEQ.nextval, '사이다', 3000);
insert into menu values(MENU_SEQ.nextval, '맥주', 5000);
